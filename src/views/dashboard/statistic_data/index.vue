        ...
        <div class="filter-box dashboard-box">
            ...
            <div class="dashboard-box-main">
                <el-form class="filter-form" inline>
                    ...
                    <el-form-item>
                        ...
                        <div>
                            ...
                            <el-input v-if="state.agentType === 2" @input="(val) => state.agentValue = val.replace(/\D/g,'')"
                                v-model="state.agentValue" :placeholder="$t('请输入代理ID')" />
                        </div>
                        <div class="item-box" style="height: 32px;">
                ...
                <div class="result-box">
                    ...
                    <div class="small-box pointer" @click="userData.getTemplateType() === 4 ?
                        handleGo('/agent/custom-rebate-record') : handleGo('/agent/receive-record')">
            ...
            <div class="small-box">
                ...
                <div class="small-box-main">
                    <div class="main-left">
                        ...
                        <div class="text title">{{$t('NEWPP投注')}}</div>
                        <div class="text title">{{$t('NEWPP投注人数')}}</div>
                        <div class="text title">{{$t('NEWPP游戏输赢')}}</div>
                    </div>
                    <div class="main-right">
