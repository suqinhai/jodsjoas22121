<template>
    <!-- 运营中心-票券中心-已派发数量 -->
	<Dialog ref="dialog" width="1100" :title="$t('已派发数量')" top="10vh" :isShowBottomButton="false" @cancel="emits('close')">
		<div class="container">
			...
			<el-table :data="state.tableData" class="table-box" border>
				<el-table-column prop="addTime_" :label="$t('派发日期')" align="center" />
...
import { getGrantDetail } from '@/api/operation.js'
...
const fetchData = (val = '') => {
    ...
    getGrantDetail(params).then(res => {
